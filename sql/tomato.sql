...
--
-- Host: localhost    Database: tomato2
-- ------------------------------------------------------
...
--
-- Table structure for table `dominance`
--

DROP TABLE IF EXISTS `dominance`;
...
CREATE TABLE `dominance` (
  ...
  PRIMARY KEY (`id`),
  KEY `centrality_index` (`centrality`),
  KEY `variance_index` (`variance`)
...
-- Dump completed on 2013-06-07 15:49:31
